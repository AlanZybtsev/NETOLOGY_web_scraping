...
class ParserVacancy:
    ...
    def get_all_url(self):
        for page in range(self.quantity_pages):
            url = f'https://spb.hh.ru/search/vacancy?text={self.search}' \
                  f'&area=1&area=2&search_field=description&page={page}'
...
if __name__ == "__main__":
    parser = ParserVacancy('python', 40)
    parser.get_all_url()
